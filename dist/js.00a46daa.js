...
window.addEventListener("load", function (e) {
  var baseURL = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&apikey=6OW78JBH84PRLQDP&symbol=';
  ...
  function _getData() {
    _getData = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(symbol) {
      var url, req, res;
  ...
  document.forms.search.addEventListener('submit', function (e) {
    e.preventDefault();
    var res = getData(e.currentTarget.elements.searchTerm.value);
    res.then(function (res) {
      console.log(Object.values(res['Time Series (Daily)'])[0]); //pull out data for list

      var data = Object.values(res['Time Series (Daily)'])[0];
      console.log(data['1. open']);

      if (res['Error Message']) {
        var errTemplate = "<p>Can't find stock quote</p>";
        document.querySelector('.results').innerHTML = errTemplate;
      } else {
        var successTemplate = "\n                <ul>\n                    <li>".concat(res['Meta Data']['2. Symbol'], "</li>\n                    <li>Date: ").concat(res['Meta Data']['3. Last Refreshed'], "</li>\n                    <li>High Price: <span>$").concat(data['1. open'], "</span></li>\n                    <li>Low Price: <span>$").concat(data['3. low'], "</span></li>\n                    <li>Closing Price: <span>$").concat(data['4. close'], "</span></li>\n                    <li>Split Coefficient: <span>$").concat(data['8. split coefficient'], "</span></li>\n                </ul>");
